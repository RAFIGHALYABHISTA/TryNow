...
<body class="bg-gray-50 min-h-screen">
    ...
    <main class="container mx-auto px-4 py-8">
        ...
        <div class="space-y-8">
            ...
            <div>
                <p class="text-lg font-semibold text-gray-800 mb-6 ml-58 mt-8">
                    👋 Hai, <span class="font-bold">{{ Auth::user()->name }}</span>! Siap lanjut TryOut hari ini?
                </p>

                <!-- Ikon Navigasi (Disesuaikan dengan desain gambar) -->
                <div class="grid grid-cols-3 gap-4 text-center mr-58 ml-58">
                    
                    <!-- Card Tryout -->
                    <a href="#" class="icon-card bg-white p-4 md:p-6 rounded-xl shadow-md flex flex-col items-center">
                        <div class="p-3 mb-2rounded-2xl">
                    ...
                    <!-- Card Achieve -->
                    <a href="#" class="icon-card bg-white p-4 md:p-6 rounded-xl shadow-md flex flex-col items-center">
                        <div class="p-3 mb-2 rounded-2xl">
            ...
            <div>
                <h3 class="text-lg font-bold mb-3 ml-58 mt-8 text-gray-800">Rekomendasi hari ini</h3>

                <div class="bg-white p-4 rounded-xl shadow-lg flex flex-col md:flex-row items-center justify-between mr-57 ml-57">
                    <div class="flex items-center space-x-4 mb-4 md:mb-0">
                        ...
                        <p class="text-base text-gray-00">Lihat Pembahasan TryOut UTBK - <span class="font-bold text-yellow-600">Premium</span></p>
                    </div>
            ...
            <!-- 4. Score Cards -->
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mr-58 ml-58 mt-10">
                ...
                <!-- Paket Aktif -->
                <div class="bg-white p-6 rounded-xl shadow-lg text-center border-2 border-gray-100">
            ...
            <div class="bg-white p-6 rounded-xl shadow-lg flex items-center space-x-4 mr-58 ml-58 mt-10 border-l-4 border-blue-600">
